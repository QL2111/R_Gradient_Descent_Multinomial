...
model <- LogisticRegressionMultinomial$new(learning_rate = 0.1, num_iterations = 1000, loss="logistique", optimizer="adam",batch_size=32, use_early_stopping=TRUE, regularization = FALSE)
# lasso F1 = 0.99
# ridge F1 = 0.99
# elasticnet F1 = 0.99
# FALSE = 0.99
